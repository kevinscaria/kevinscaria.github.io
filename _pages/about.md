...
I am an Applied Scientist at Amazon Alexa, where I work on building responsible AI guardrails for large language models (LLMs) and conducting research on mitigating security vulnerabilities in large action models (LAMs), including prompt injection and indirect attack vectors.

My work focuses on model alignment, safety, and runtime policy enforcement, spanning post-training of language models, retrieval-augmented generation (RAG), and multi-agent control systems for trust and safety at scale.
...
Research
======
My research interests include Post Training, LLM Reasoning, LLM Security, Instruction Tuning, Creation & Curation of Benchmarks, 
...
Papers
======
* **[PolyMATH: A Challenging Multi-modal Mathematical Reasoning Benchmark](https://openreview.net/pdf?id=Lo3rfMg19d)** <br>
Himanshu Gupta\*, Shreyas Verma\*, Ujjwala Anantheswaran\*, ***Kevin Scaria***\*, Mihir Parmar, Saurabh Arjun Sawant, Swaroop Mishra, Chitta Baral <br>
  **NeurIPS 2025** - FoRLM Workshop (\* - Equal First Author Contribution) <br>

* **[Cutting Through the Noise: Boosting LLM Performance on Math Word Problems](https://iclr.cc/virtual/2025/32749)** <br>
Ujjwala Anantheswaram, ***Kevin Scaria***, Himanshu Gupta, Swaroop Mishra, Chitta Baral <br>
  **ICLR 2025** - Workshop on Reasoning and Planning for Large Language Models<br>
...
* **[Rule-Based Error Detection and Correction to Operationalize Movement Trajectory Classification](https://ceur-ws.org/Vol-4102/paper3.pdf)** <br>
Bowen Xi, ***Kevin Scaria***, Paulo Shakarian <br>
  **IJCAI 2025** - Workshop on Spatio-Temporal Reasoning and Learning<br>
...
* **01.2019-12.2021** Data Scientist at an AI consulting firm - [Tiger Analytics](https://www.tigeranalytics.com/). 
